...
export default function DownloadContactBar() {
  return (
    <div id="download-section" className="w-full flex flex-col items-center gap-4 py-8 px-4">
      ...
      <motion.a
        ...
        className="golden-button-shine w-full md:w-auto min-w-[260px] flex items-center justify-center gap-3 py-4 px-6 rounded-lg text-lg cursor-pointer"
      >
