...
export default function Header() {
  return (
    <header className="w-full bg-white border-b border-gray-100 py-5 px-4 md:px-8 flex items-center justify-between sticky top-0 z-50">
      {/* Logo */}
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          {['Charts', 'Games', 'About Us'].map((item) => (
            <Link
              key={item}
              href="#"
              className="px-4 py-1.5 rounded-full text-sm font-semibold transition-colors hover:bg-[#EAA938] hover:text-white"
              style={{
                color: '#EAA938',
                border: '1.5px solid #EAA938',
              }}
            >
              {item}
            </Link>
        ...
        <a
          href="#"
          className="w-9 h-9 flex items-center justify-center rounded-full text-white shadow-sm transition-transform hover:scale-105"
